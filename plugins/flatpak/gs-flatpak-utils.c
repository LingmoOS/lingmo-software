				...
				gboolean is_user)
{
	...
	gs_app_set_metadata (app, "LingmoSoftware::SortKey", "100");
	gs_app_set_metadata (app, "LingmoSoftware::InstallationKind",
...
gs_flatpak_app_set_packaging_info (GsApp *app)
{
	...
	gs_app_set_metadata (app, "LingmoSoftware::PackagingBaseCssColor", "flatpak_packaging_color");
	gs_app_set_metadata (app, "LingmoSoftware::PackagingIcon", "flatpak-symbolic");
	gs_app_set_metadata (app, "LingmoSoftware::packagename-title", _("App ID"));
}
