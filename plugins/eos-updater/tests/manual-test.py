...
class ManualTest(dbusmock.DBusTestCase):
    '''A manual test of the eos-updater plugin in lingmo-software.

    It creates a mock eos-updater D-Bus daemon, on the real system bus (because
    otherwise lingmo-software’s other plugins can’t communicate with their
    system daemons; to fix this, we’d need to mock those up too). The test
    harness provides the user with instructions about how to run lingmo-software
    ...
    cancellation of the daemon from lingmo-software; and the daemon unexpectedly
    ...
    def setUp(self):
        ...
        # lingmo-software needs to access various other services (such as
    ...
    def tearDown(self):
        self.kill_lingmo_software()
        self.p_mock.terminate()
        self.p_mock.wait()

    def launch_lingmo_software(self):
        '''Instruct the user to launch lingmo-software'''
        print('Launch lingmo-software with:')
        print('lingmo-software --verbose')
        self.manual_check('Press enter to continue')

    def kill_lingmo_software(self):
        '''Instruct the user to kill lingmo-software'''
        print('Kill lingmo-software with:')
        print('pkill lingmo-software')
        self.manual_check('Press enter to continue')
    ...
    def test_poll_eos_updater_dies(self):
        '''Test that lingmo-software recovers if eos-updater dies while
        polling for updates.'''
        self.dbusmock.SetPollAction(
            'update', dbus.Dictionary({}, signature='sv'), '', '')
