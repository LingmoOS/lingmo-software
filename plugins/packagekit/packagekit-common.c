...
gs_plugin_packagekit_set_packaging_format (GsPlugin *plugin, GsApp *app)
{
	if (gs_plugin_check_distro_id (plugin, "fedora") ||
		...
		gs_app_set_metadata (app, "LingmoSoftware::PackagingFormat", "deb");
	} else {
		return;
	}
				       ...
				       PkPackage *package)
{
	...
	if (gs_app_get_metadata_item (app, "LingmoSoftware::packagename-value") != NULL)
		return;
	...
	gs_app_set_metadata (app, "LingmoSoftware::packagename-value", tmp);
}
