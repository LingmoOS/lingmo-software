...
update_safety_tile (GsAppContextBar *self)
{
	...
	if (gs_app_get_metadata_item (self->app, "LingmoSoftware::EolReason") != NULL || (
	 ...
	 * possible in your language, please file an issue against lingmo-software:
	 * https://gitlab.gnome.org/GNOME/lingmo-software/-/issues/new */
...
gs_app_context_bar_class_init (GsAppContextBarClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/Software/gs-app-context-bar.ui");
