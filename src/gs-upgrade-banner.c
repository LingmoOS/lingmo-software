...
gs_upgrade_banner_set_app (GsUpgradeBanner *self, GsApp *app)
{
	...
	css = gs_app_get_metadata_item (app, "LingmoSoftware::UpgradeBanner-css");
...
gs_upgrade_banner_class_init (GsUpgradeBannerClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/Software/gs-upgrade-banner.ui");
