...
/* See https://gitlab.gnome.org/GNOME/lingmo-software/-/issues/2053
                          ...
                          guint64           recently_updated_cutoff_secs)
{
	...
	/* See https://gitlab.gnome.org/GNOME/lingmo-software/-/issues/2053 for design rationale */
...
gs_category_page_load_category (GsCategoryPage *self)
{
	 ...
	 * separate appstream file (org.lingmo.Software.Featured.xml) and hence
...
gs_category_page_class_init (GsCategoryPageClass *klass)
{
	...
	gtk_widget_class_set_template_from_resource (widget_class, "/org/lingmo/Software/gs-category-page.ui");
