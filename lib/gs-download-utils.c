 ...
 *
 * Build a new #SoupSession configured with the lingmo-software user agent.
 *
                  ...
                  gpointer      user_data)
{
	 ...
	 * modification time of the local file equals when lingmo-software last
	 * checked for updates to it — which is correct to send as the
	 * If-Modified-Since the next time lingmo-software checks for updates to
	 * the file. */
